...
const EventTile = ({day, month, year, name, street, number, codePostal, city}) => {
  return (
    <section className='text-center bg-blue-600 text-neutral-200 rounded-2xl mt-15 p-5'>
        ...
        <p className='bg-indigo-50 text-neutral-800 rounded-2xl py-1 font-bold'>{day} {monthNames[month].full} {year}</p>
        ...
        <p className='bg-indigo-50 text-neutral-800 rounded-2xl py-1 font-bold'>
            ...
            {name} ({street}, {number} - {codePostal} {city})
        </p>
    </section>
  )
}
